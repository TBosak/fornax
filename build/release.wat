(module
 ...
 (data $13.1 (i32.const 1608) "\02\00\00\00\02\00\00\00\r")
 (data $14 (i32.const 1628) "\1c")
 (data $14.1 (i32.const 1640) "\02\00\00\00\02\00\00\00\t")
 (data $15 (i32.const 1660) ",")
 (data $15.1 (i32.const 1672) "\02\00\00\00\0e\00\00\00 \00{\00}\00:\00;\00,\00.")
 (data $16 (i32.const 1708) "<")
 (data $16.1 (i32.const 1720) "\02\00\00\00*\00\00\00O\00b\00j\00e\00c\00t\00 \00a\00l\00r\00e\00a\00d\00y\00 \00p\00i\00n\00n\00e\00d")
 (data $17 (i32.const 1772) "<")
 (data $17.1 (i32.const 1784) "\02\00\00\00(\00\00\00O\00b\00j\00e\00c\00t\00 \00i\00s\00 \00n\00o\00t\00 \00p\00i\00n\00n\00e\00d")
 (data $18 (i32.const 1840) "\04\00\00\00 \00\00\00 \00\00\00 ")
 ...
 (func $assembly/utilities/minifyCSS (param $0 i32) (result i32)
  ...
  block $folding-inner0
     ...
     block $for-continue|0
      ...
      if
       ...
       if (result i32)
        ...
        local.get $5
        i32.store
        block $__inlined_func$~lib/string/String#indexOf$136
         local.get $5
         i32.const 20
         i32.sub
         i32.load offset=16
         ...
         if
          ...
          i32.const 0
          local.set $3
          br $__inlined_func$~lib/string/String#indexOf$136
         end
         global.get $~lib/memory/__stack_pointer
         i32.const 1680
         i32.store
   ...
   block $__inlined_func$~lib/string/String#trim$137
    local.get $0
    i32.eqz
    if
     global.get $~lib/memory/__stack_pointer
     ...
     i32.const 1056
     local.set $2
     br $__inlined_func$~lib/string/String#trim$137
    end
    local.get $3
    i32.eqz
    local.get $0
